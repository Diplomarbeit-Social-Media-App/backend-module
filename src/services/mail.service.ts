...
export const sendAccountDeletionEmail = async (toMail: string) => {
  return await transport.sendMail({
    to: toMail,
    from: config.EMAIL_FROM_ADDRESS,
    subject: 'Ihr Account wurde gelöscht',
    html: `
    <!DOCTYPE html>
    <html lang="de">
    <head>
    ...
    <body>
        <div class="email-container">
            <div class="header">
                <h1>Account gelöscht</h1>
            </div>
            <div class="content">
                <p>Hallo,</p>
                <p>wir haben Ihren Account gelöscht, da er innerhalb der erforderlichen Zeitspanne nicht aktiviert wurde.</p>
                <p>Falls Sie weiterhin Interesse an unseren Diensten haben, können Sie sich jederzeit erneut registrieren.</p>
...
export const sendAccountDeletionByAdmin = async (email: string) => {
  return await transport.sendMail({
    to: email,
    from: config.EMAIL_FROM_ADDRESS,
    subject: 'Ihr Account wurde gelöscht',
    ...
    <body>
        <div class="email-container">
            ...
            <div class="content">
                <p>Hallo!</p>
                <p>Ihr Account wurde von unserem Management gelöscht!</p>
...
export const sendVerifyEmail = async (token: string, toMail: string) => {
  return await transport.sendMail({
    ...
    <body>
        <div class="email-container">
            <div class="header">
                <h1>Account Verifizierung</h1>
            </div>
            <div class="content">
                <p>Hallo,</p>
                <p>Ihr Einmal-Token zur Account-Verifizierung lautet:</p>
                <div class="token">${token}</div>
                <p>Bitte geben Sie diesen Code in Ihrer App ein, um Ihren Account zu aktivieren.</p>
